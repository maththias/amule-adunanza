...
# This script gets called by /etc/init.d/amule-adunanza-daemon, and its purpose
# is to honour the AMULED_HOME variable in /etc/default/amule-adunanza-daemon.
...
exec /usr/bin/amuled-adunanza -f
